 ...
 * @param patCode, the full patient code which is gonna be saved. it will be the
 * patient identifier
 * @return
 */	
 ...
 * @param user, the user (interviewer) doing the performance
 * @param perf, the performance in about to start
