	 ...
	 */	
		public static int createSection (Session hibSess, String name,
			...
			try {
				...
				newSec.setSectionOrder(intr.getSections().size()+1);
				tx.commit();
...
//				itemCol = aux.getItems();
	 ...
	 */
		public static boolean createEnumType (Session hibSes, Interview owner, 
